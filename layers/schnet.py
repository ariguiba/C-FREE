...
from layers.model_utils.encoders import get_node_encoder
...
class MySchNet(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.dipole:
            ...
            self.register_buffer('atomic_mass', atomic_mass.detach().clone())
        ...
        self.register_buffer('initial_atomref', atomref.detach().clone() if atomref is not None else None)
        self.atomref = None
    ...
    def forward(self, h, z: Tensor, pos: Tensor,
